...
<script>
function myFunction() {
  alert("Data will be permanently lost!");
}
</script>
    ...
    <div align="center">
        ...
        <table class="table-borderless"  cellspacing="0" cellpadding="10">
            <?php foreach ($record as $rec) : ?>
                <tr>
                    <td><b><?= date('d F Y', strtotime($rec['dates'])); ?></b></td>
                    <td><b><?= $rec['category']; ?></b></td>
                    <td><b>Rp<?= $rec['amount']; ?></b></td>
                    <td style ="text-align: center;"><a href="update_record.php?id=<?= $rec['id']; ?>" class="button" ><b>Edit</b></a>
                        <a href="delete_record.php?id=<?= $rec['id']; ?>" class="button1" onclick="myFunction()"><b>Delete</b></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </table>
