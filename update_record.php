        ...
        <form action="" method="post">
            <table class="table-borderless" cellspacing="0" cellpadding="10">
                ...
                <tr>
                    ...
                    <td style = "background-color: #0066ff"><input type="datetime-local" name="dates" value="<?= date('Y-m-d\TH:i:s', strtotime($record[0]['dates'])); ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style = "background-color: #0066ff"><input type="number" name="amount" value="<?= $record[0]['amount']; ?>" required></td>
                </tr>
                <tr>
                    <td colspan="2" style= "text-align: center"><button type="submit" name="update" class="button">Update</button><a href="index.php" class="button1">Cancel</a></td>
